...
@Component({
  selector: 'app-detaildemande-h1',
  templateUrl: './detaildemande-h1.component.html',
  styleUrls: ['./detaildemande-h1.component.css']
})
export class DetaildemandeH1Component implements OnInit {
  ...
  // addnotification(){
  //   this.apinotification.addnotification(this.id,this.detailForm).subscribe((res:any)=>{
  //     console.log("notification",res)
  //   })
  // }

  onSubmit(){
    this.apidata.donneravisH1(this.id,this.NotificationForm.value.avisH1).subscribe((res:any)=>{
      Swal.fire(
        'added!',
